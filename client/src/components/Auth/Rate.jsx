...
export default function Profile(props){
    ...
    useEffect(() => {
        ctx.id && axios.get("http://143.198.233.198:5000/api/ratings",{
    ...
    const handleLogout = () => {
        axios.get("http://143.198.233.198:5000/api/logout", {
        withCredentials: true
        }).then((res) => {
        if (res.data === "success") {
            localStorage.clear();
    ...
    const handleSubmit = () => {
        ctx.id && axios.post("http://143.198.233.198:5000/api/rating",input, {
        withCredentials: true
        }).then((res) => {
        if (res.data === "success") {
            setAlert({
    ...
    const handleEdit = () => {
        axios.put("http://143.198.233.198:5000/api/rating",input, {
        withCredentials: true
        }).then((res) => {
        if (res.data === "success") {
            setAlert({
    ...
    const handleDelete = () => {
        ...
        axios.delete(`http://143.198.233.198:5000/api/rating/${rating.id}`, {
        withCredentials: true
        }).then((res) => {
        if (res.data === "success") {
            setAlert({
